...
note1=AppointmentNote.create(title: "Appointment 2/14/2020", notes: "I need to work on being more positive. Start your days with a positive thought", user_id: user3.id, practitioner_id: Practitioner.first.id)
note2=AppointmentNote.create(title: "Appointment 5/14/2020", notes: "Confidence is there but work on speaking more. Start your days with a positive thought", user_id: user3.id, practitioner_id: Practitioner.first.id)
note3=AppointmentNote.create(title: "Appointment 8/14/2020", notes: "Talk to mom about thanksgiving and why you were upset. Things i was upset about: the money, the way she asked was triggering", user_id: user3.id, practitioner_id: Practitioner.first.id)
note4=AppointmentNote.create(title: "Appointment 1/14/2021", notes: "Talk to HR about your options. Remember to have evidence", user_id: user2.id, practitioner_id: Practitioner.first.id)
